  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <a href="https://www.gradescope.com/courses/382080" target="_blank">
            gradescope
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="https://wd5.myworkday.com/uw/d/home.htmld" target="_blank">
            workday
          </a>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <a href="https://github.com/colehahn/Study-Buddy" target="_blank">
            github repo
          </a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <a href="https://www.gradescope.com/courses/380472" target="_blank">
            gradescope
          </a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <a href="https://www.gradescope.com/courses/377411" target="_blank">
            gradescope
          </a>
        </li>
        <li>
